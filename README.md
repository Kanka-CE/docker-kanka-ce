...
For a detailed instruction how to run the the development build see the [Wiki page](https://github.com/kanka-ce/kanka-community-edition/wiki/Development).

## Contributing

Kanka Community Edition and Kanka CE Tools can only exist if the community helps build it.
To get started, you can read the [contributing guide](https://github.com/kanka-ce/kanka-ce-container/blob/main/CONTRIBUTING.md) 
or take a look at the [ToDo List](https://github.com/kanka-ce/kanka-community-container/blob/develop-ce/TODO.md).
...
Note that Kanka itself is licesed under the [“Commons Clause” License Condition v1.0](https://github.com/owlchester/kanka/blob/develop/LICENSE).
